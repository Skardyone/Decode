...
const Band = () => {
  return (
    <div className='w-full px-4 bg-[#212139] pb-8'>
        <div className='flex w-full flex-col justify-evenly px-12'>
            <div className="verunka w-full flex flex-row justify-center -mb-8 h-auto">
            ...
            <div className="verunka w-full flex flex-row justify-center h-auto">
                ...
                <div className='basis-1/2 flex items-center object-contain'><Image src={Milan} alt="" className='h-auto' /></div>
            </div>
        </div>
    </div>
  )
